...
const ProductTable = ({
  ...
  return (
    ...
    >
      <div className={`grid   text-sm text-[#001625] bg-[#F6F5F6] px-5 py-5 w-full rounded-xl ${columns.length === 6 ? 'grid-cols-[5%_35%_10%_10%_30%_10%]' : 'grid-cols-[5%_35%_10%_10%_10%_10%_20%]'}`}>
