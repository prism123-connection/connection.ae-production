...
<div className="border rounded py-5 flex flex-col items-center justify-center cursor-pointer border-solid border-[rgba(0,0,0,0.3)] hover:border-[#DB4444] transition-colors group">
    <div>
    <div className="mb-4">{icon}</div>
    <div className="text-base text-black text-center group-hover:text-[#DB4444]">{title}</div>
    </div>
</div>
);
...
const RealEstateIcon = () => (
  ...
  const EcommerceCategories = () => {
    ...
    { title: "F&B", icon: <FoodIcon /> },
    { title: "Furniture", icon: <FurnitureIcon /> },
    { title: "Fashion", icon: <FashionIcon /> },
    { title: "Toys", icon: <ToysIcon /> },
  ];
    ...
    return (
        ...
        <div className="grid grid-cols-[repeat(6,1fr)] gap-[30px] mb-[60px] max-md:grid-cols-[repeat(3,1fr)] max-sm:grid-cols-[repeat(2,1fr)]">
