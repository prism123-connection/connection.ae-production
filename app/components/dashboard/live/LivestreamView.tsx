...
export const LivestreamView: React.FC<LivestreamViewProps> = ({ call }) => {
    const {
      useCameraState,
      useMicrophoneState,
      useParticipantCount,
  ...
  <ParticipantView ParticipantViewUI={CustomParticipantViewUI} VideoPlaceholder={CustomVideoPlaceHolder} className="min-w-full! h-[100%] flex flex-col items-center justify-center gap-1" participant={firstParticipant} />
    ...
    <div className="flex gap-4 text-white">
      <button className="bg-gray-800 font-semibold text-blue-100 px-20 py-2 rounded-sm" onClick={() => (isLive ? call.stopLive() : call.goLive())}>
