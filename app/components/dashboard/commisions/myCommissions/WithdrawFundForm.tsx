...
interface WithdrawFormProps {
  ...
  export const WithdrawFundForm: React.FC<WithdrawFormProps> = ({ onNext, onPrev }) => {
  ...
  return (
    ...
    <div className="bg-white shadow-[0px_2px_4px_rgba(0,0,0,0.12)] flex w-full flex-col items-stretch rounded-xl pb-5">
