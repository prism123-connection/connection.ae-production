...
export const StatsCard: React.FC<StatsCardProps> = ({
  ...
  return (
    <div className="justify-center items-stretch border border-[color:var(--gray-200,#E4E4E7)] bg-white flex flex-col flex-1 rounded-[10px] border-solid shadow-sm">
      <div className="w-full p-[15px] rounded-[10px]">
        ...
        <div className="flex w-full max-w-[249px] gap-[40px_100px] justify-between mt-[11px]">
          <div className="gap-2.5 text-[21px] text-zinc-900 font-bold whitespace-nowrap leading-loose">
            {value}
          </div>
          <div
