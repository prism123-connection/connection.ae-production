...
const EntityInformation = () => {
  const businessData = {
    ...
    registrationNumber: "1234555789",
    dateOfExpiry: "22/08/2029",
    dateOfIncorporation: "05/10/2020",
    countryOfIncorporation: "United States of America",
    typeOfEntity: "LLC",
    registrationAddress: "123, Springfield, Illinois, USA",
    operationalAddress: "123, Springfield, Illinois, USA"
  };
          ...
          <div className="px-2 space-y-4">
            <div className="grid gap-4">
              ...
              <div className="flex justify-between items-start  ">
                ...
                <span className="font-semibold text-gray-900 text-right">{businessData.entityName}</span>
              </div>
              
              <div className="flex justify-between items-start  ">
                <span className="font-medium text-gray-600 min-w-[140px]">Registration Number:</span>
                <span className="font-semibold text-gray-900 text-right">{businessData.registrationNumber}</span>
              </div>
              ...
              <div className="flex justify-between items-start  ">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-gray-900">{businessData.dateOfExpiry}</span>
                </div>
              </div>
              ...
              <div className="flex justify-between items-start  ">
                ...
                <div className="flex items-center gap-2">
                  <Calendar className="h-4 w-4 text-gray-500" />
                  <span className="font-semibold text-gray-900">{businessData.dateOfIncorporation}</span>
                </div>
              </div>
              
              <div className="flex justify-between items-start  ">
                <span className="font-medium text-gray-600 min-w-[140px]">Country of Incorporation:</span>
                <span className="font-semibold text-gray-900 text-right">{businessData.countryOfIncorporation}</span>
              </div>
              
              <div className="flex justify-between items-start  ">
                <span className="font-medium text-gray-600 min-w-[140px]">Type of Entity:</span>
                  <span className="font-semibold text-gray-900 text-right">{businessData.typeOfEntity}</span>
              </div>
              ...
              <div className="flex justify-between items-start  ">
                ...
                <div className="flex items-start gap-2 text-right">
                  ...
                  <span className="font-semibold text-gray-900">{businessData.registrationAddress}</span>
                </div>
              </div>
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="flex items-start gap-2 text-right">
                  <MapPin className="h-4 w-4 text-gray-500 mt-0.5 flex-shrink-0" />
                  <span className="font-semibold text-gray-900">{businessData.operationalAddress}</span>
                </div>
              </div>
            </div>
          </div>
