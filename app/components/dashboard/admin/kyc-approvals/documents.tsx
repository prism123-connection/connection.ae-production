...
const Documents = () => {
  ...
  <div className="grid gap-4">
    <div className="flex justify-between items-start">
      ...
      <a href={documents.tradeLicenseUrl} className="text-blue-600 underline" target="_blank">View Document</a>
    </div>
    <div className="flex justify-between items-start">
      <span className="font-medium text-gray-600 min-w-[140px]">Passport Copies:</span>
      <a href={documents.passportCopiesUrl} className="text-blue-600 underline" target="_blank">View Document</a>
    </div>
    <div className="flex justify-between items-start">
      <span className="font-medium text-gray-600 min-w-[140px]">Board Resolution:</span>
      <a href={documents.boardResolutionUrl} className="text-blue-600 underline" target="_blank">View Document</a>
    </div>
    <div className="flex justify-between items-start">
      <span className="font-medium text-gray-600 min-w-[140px]">Proof of Address:</span>
      <a href={documents.proofOfAddressUrl} className="text-blue-600 underline" target="_blank">View Document</a>
    </div>
    {documents.additionalDocumentsUrl && (
      <div className="flex justify-between items-start">
        <span className="font-medium text-gray-600 min-w-[140px]">Additional Documents:</span>
        <a href={documents.additionalDocumentsUrl} className="text-blue-600 underline" target="_blank">View Document</a>
      </div>
    )}
  </div>
</div>
