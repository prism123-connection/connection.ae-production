...
const AccountSetupPage = () => {
  ...
  const activeClass = "bg-[#1F587C] w-10 h-10 rounded-full text-lg text-center text-white flex items-center justify-center pb-0.5 cursor-pointer"
  const normalClass = "bg-[#1F587C]/10 text-[#1F587C]/50 w-10 h-10 rounded-full text-lg text-center font-medium border-2 border-[#1F587C]/30 flex items-center justify-center pb-0.5 -ml-1.5 cursor-pointer"

  return (
    <div className=" w-full flex overflow-hidden!  relative justify-center items-center">
      ...
      <div className="w-full  bg-white/70  z-10 backdrop-blur-xl  rounded-4xl flex flex-col items-center justify-start py-5 ">
      
      {/* Heading & fill text */}
      <span className="text-5xl font-semibold bg-gradient-to-r from-[#51C2FF] via-[#A9EE86] to-[#FFA442] text-transparent bg-clip-text  decoration-[#51C2FF] leading-20"> Finish Setting up your Account </span>
      <span className="text-base mt-4 text-[#333333]">Please fill in the details</span>
      
      {/* Top step numbers  */}
      <div className="flex mt-5 ">
      <div
      className={activeCount === 1 ? activeClass : normalClass}>
        1
      </div>
      <RigthArrow/>
      
      <div
      className={`${activeCount === 2 ? activeClass : normalClass} -ml-1.5`}>
        2
      </div>
      <RigthArrow/>
      <div
      className={`${activeCount === 3 ? activeClass : normalClass} -ml-1.5`}>
       3
      </div>
      </div>
      ...
      {/* Inputs  */}
      {activeCount === 1 && 
      <span className="text-[#333] text-lg font-medium w-full px-40">1. Personal Info</span>
      }
      {
        activeCount === 1 && 
    ...
    />  
      ...
      {activeCount === 2 && 
      <span className="text-[#333] text-lg font-medium w-full px-40">2. Address and other details</span>
      }
      {
        activeCount === 2 && 
      <div className="w-full gap-5  flex flex-col items-end px-40 mt-5">
      ...
      <ProceedButtons classes="bg-white text-black!" onClickFunc={()=>setActiveCount(1)} >
        Back
      </ProceedButtons>
      <ProceedButtons onClickFunc={handleNext} >
        Next 
       ...
       {activeCount === 3 && 
      <span className="text-[#333] text-lg font-medium w-full px-40">3. Business details</span>
      }
      {
        activeCount === 3 && 
      <div className="w-full gap-5  flex flex-col items-end px-40 mt-5">
      ...
      <ProceedButtons classes="bg-white text-black!" onClickFunc={()=>setActiveCount(2)} >
        Back
      </ProceedButtons>
      {
        loading ?   
